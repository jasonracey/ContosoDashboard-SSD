...
- **FR-015**: Users MUST be able to sort their document list by title, upload date, category, or file size, in ascending or descending order (the order options MUST list ascending before descending, and ascending MUST be the default selection).
